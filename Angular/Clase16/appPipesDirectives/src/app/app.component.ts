...
export class AppComponent {
	...
	mostrarImagen(archivos: FileList) {
		//Para convertir un objeto en binario
		//Se utiliza FileReader() que es una clase de JavaScript
		const fr: FileReader = new FileReader()
		//Evento onloadden indica cuando ya se convirtio en binario
		//Es una funcion que recibe un unico parametro.
		fr.onloadend = (e) => {
			this.imagenBase64 = (e.target as FileReader).result
		}
		//Convierte el archivo file en binario que se pueda asignar a una etiqueda img.
		//Esta transformación no es inmmediata, por lo que se utilizan otros eventos. 
